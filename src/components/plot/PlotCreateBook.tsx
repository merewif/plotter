...
const CreateBook = () => {
  ...
  useEffect(() => {
    ...
    if ('books' in localStorage && Object.keys(JSON.parse(localStorage.books)).length === 0) {
      localStorage.removeItem('books');
    }
  }, []);

  function addBook(event: any) {
  ...
  function confirmBooks(event: any) {
    // event.preventDefault();
    // setButtonText('Saved');
    // let bookObject = {};
